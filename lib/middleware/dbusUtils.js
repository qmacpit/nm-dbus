...
function _prepareDBusData(data){
    var currentKey, currentValue;
    for (currentKey in data) {
        currentValue = data[currentKey];
        if (typeof currentValue === "object")
            _prepareDBusData(currentValue);
        else {
            if (currentValue === undefined
                || currentValue === true    //dbus NM configuration seems to store only false value
                || currentValue === null
                || currentValue === "")
...
module.exports = {
    ...
    prepareDBusData: _prepareDBusData,
