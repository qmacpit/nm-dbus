...
module.exports = {
     ...
     *              data - signal data
     */
    on: function(object, interface, signal, callback) {
        return DBusConnector.on(object, interface, signal, function(err,data){
            if (callback)
                callback(err, {
                    object: object,
                    interface: interface,
    ...
    onActiveConnectionStateChanged: function(activeConectionId, callback) {
        this.on(activeConectionId, _dbusData["ActiveConnection"].interface, "PropertiesChanged", callback);
    }
