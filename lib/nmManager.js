...
module.exports = {
     ...
     *  Parameters:
     *      type [String] - specify a type of device to be returned i.e 8 for modems.
    ...
    on: function(service, object, interface, signal, callback) {
        ...
        DBusConnector.on(service, object, interface, signal, function(err,data){
            deactiveable.performCallback(err, {
                object: object,
                interface: interface,
                data: data
            });
